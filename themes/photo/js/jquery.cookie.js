...
<html lang="en">
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MzQ2OTgxNzE2OmM5MTI4NTcxMmY4ZWZkMGEwZGEwMWJkMDFhMjljMTYwOGJhMDNlZTNkYjM1MjZkYWRhMmY2YjgxMDExYjA3YjQ=--97e9109f45bc3e9633fa1ec6153c01520471a034">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="66D0:7974:152BE4E:242D2E7:5C5F4C14" data-pjax-transient>
  ...
  <meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="66D0:7974:152BE4E:242D2E7:5C5F4C14" /><meta name="octolytics-dimension-region_edge" content="iad" /><meta name="octolytics-dimension-region_render" content="iad" /><meta name="octolytics-actor-id" content="3447883" /><meta name="octolytics-actor-login" content="Indrajit77" /><meta name="octolytics-actor-hash" content="22daa55e6ab177479ae116c2ad0d3c70f66bd4b0e822ceafde11f1fa8a1fbe73" />
<meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" />
  ...
  <meta class="js-ga-set" name="userId" content="fca46f651994311f2ef70eb5416cf76b">
...
<meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="Indrajit77">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="NDk1NDVlYWZjYzM1MmNiNDI1Mzg4Y2Q2YTZkMzMwNTgyNjZjOTBiN2NhZWE1OGI1MjlmOGE5ZjYxZTQwMTJmY3x7InJlbW90ZV9hZGRyZXNzIjoiNDIuMTA5LjEuMTAwIiwicmVxdWVzdF9pZCI6IjY2RDA6Nzk3NDoxNTJCRTRFOjI0MkQyRTc6NUM1RjRDMTQiLCJ0aW1lc3RhbXAiOjE1NDk3NDkyODcsImhvc3QiOiJnaXRodWIuY29tIn0=">
  ...
  <meta name="html-safe-nonce" content="8c7c4d5df48d95b479fb6dc7452c5337657f8762">
...
>
  <div class="position-relative">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="268027" data-scoped-search-url="/carhartl/jquery-cookie/search" data-unscoped-search-url="/search" action="/carhartl/jquery-cookie/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          aria-label="Search or jump to…"
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=bq1vOg/jOTes+TQR5xBB9VcGjEAmlOY1SuCdNwKIhwqO6x1nwnM0tzYo19oqfcjobxSnVIxIdcTou7qM0kIziw=="
          spellcheck="false"
          autocomplete="off"
          >
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown">
    ...
    <a aria-label="You have unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-hotkey="g n" data-ga-click="Header, go to notifications, icon:unread" data-channel="notification-changed:3447883" href="/notifications">
  ...
  <li class="dropdown">
    ...
    <details class="details-overlay details-reset d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@Indrajit77" class="avatar float-left mr-1" src="https://avatars2.githubusercontent.com/u/3447883?s=40&amp;v=4" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>
      <details-menu class="dropdown-menu dropdown-menu-sw">
        <div class="header-nav-current-user css-truncate"><a role="menuitem" class="no-underline user-profile-link px-3 pt-2 pb-2 mb-n2 mt-n1 d-block" href="/Indrajit77" data-ga-click="Header, go to profile, text:Signed in as">Signed in as <strong class="css-truncate-target">Indrajit77</strong></a></div>
...
<div class="js-user-status-container user-status-compact" data-team-hovercards-enabled>
  <details class="js-user-status-details details-reset details-overlay details-overlay-dark">
    ...
    <details-dialog class="details-dialog rounded-1 anim-fade-in fast Box Box--overlay" role="dialog" tabindex="-1">
      <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="position-relative flex-auto js-user-status-form" action="/users/status?compact=1&amp;link_mentions=0&amp;truncate=1" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="dn12cii2pa6O4DmSUhSs+TjTEz9M1aSg8EEqbwEvuadWU/NGrtdzZpFF4qNpolSnrj24mm7cs4TsIZR/O0v27g==" />
        ...
        <a role="menuitem" class="dropdown-item" href="/Indrajit77" data-ga-click="Header, go to profile, text:your profile">Your profile</a>
        <a role="menuitem" class="dropdown-item" href="/Indrajit77?tab=repositories" data-ga-click="Header, go to repositories, text:your repositories">Your repositories</a>

        <a role="menuitem" class="dropdown-item" href="/Indrajit77?tab=projects" data-ga-click="Header, go to projects, text:your projects">Your projects</a>

        <a role="menuitem" class="dropdown-item" href="/Indrajit77?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">Your stars</a>
          <a role="menuitem" class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, your gists, text:your gists">Your gists</a>

        <div role="none" class="dropdown-divider"></div>
        <a role="menuitem" class="dropdown-item" href="https://help.github.com" data-ga-click="Header, go to help, text:help">Help</a>
        <a role="menuitem" class="dropdown-item" href="/settings/profile" data-ga-click="Header, go to settings, icon:settings">Settings</a>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="logout-form" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="i+WVm9W5UxmSUhrHPucWM6KrgNV9CKWcvt1PkoOHtMAdNhgv3fCZ1q8R5Rl4kg0IoA7gHat4Pt3lyPFdLKxRlw==" />
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="sr-only right-0" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="TQnwuYcpgznOQypu/791U6mtVx2Vr9HQVPdqAW7IqOnb2n0Nj2BJ9vMA1bC5ym5oqwg31UPfSpEP4tTOweNNvg==" />
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-remote="true" class="js-social-form js-social-container" action="/notifications/subscribe" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="p+DfCf0o/g/3dHbxJGUzsRoiL2lvvmt4F5z2FTlLc5EL7ESaDg3NbAR07RzAfvaOK62tO3Px5XChX3qRpQijjw==" />      <input type="hidden" name="repository_id" id="repository_id" value="268027" class="form-control" />
      ...
      <a class="social-count js-social-count"
        ...
        aria-label="458 users are watching this repository">
        458
      </a>
</form>
  </li>
  ...
  <li>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="starred js-social-form" action="/carhartl/jquery-cookie/unstar" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="Km+u2dJSDJipi4nkPDc1oPKVQebOuVIDW/8qTyLGrwZrIepKqc4iEpokiWgtJXYTub2eO9LoUq/SLUXrOH9UJw==" />
      ...
      <button
        ...
        <a class="social-count js-social-count" href="/carhartl/jquery-cookie/stargazers"
           aria-label="8594 users starred this repository">
          8,594
        </a>
</form>
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="unstarred js-social-form" action="/carhartl/jquery-cookie/star" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="2qBt2xYz5yumNfqGiHPsvsFPSo405hGXO01R+rMY3aNEtE0Mctmh//zCgcn+rZuqH7vS73SOOQWjwjyeyozo0A==" />
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <details class="details-reset details-overlay details-overlay-dark d-inline-block float-left"
            data-deferred-details-content-url="/carhartl/jquery-cookie/fork?fragment=1">
            ...
            <details-dialog class="anim-fade-in fast Box Box--overlay d-flex flex-column">
              <div class="Box-header">
                ...
                <h3 class="Box-title">Fork jquery-cookie</h3>
              </div>
              <div class="overflow-auto text-center">
                <include-fragment>
                  <div class="octocat-spinner my-3" aria-label="Loading..."></div>
                  <p class="f5 text-gray">If this dialog fails to load, you can visit <a href="/carhartl/jquery-cookie/fork">the fork page</a> directly.</p>
                </include-fragment>
              </div>
            </details-dialog>
          </details>
    ...
    <a href="/carhartl/jquery-cookie/network/members" class="social-count"
       aria-label="3923 users forked this repository">
      3,923
    </a>
  </li>
</ul>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    ...
    <a class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors dependency_graph pulse alerts security people /carhartl/jquery-cookie/pulse" href="/carhartl/jquery-cookie/pulse">
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  <div class="repository-content ">
    ...
    <!-- blob contrib key: blob_contributors:v21:35418d4847de0bbb3bf7f2e70b203002 -->
...
<details class="details-reset details-overlay select-menu branch-select-menu float-left">
  ...
  <details-menu class="select-menu-modal position-absolute" style="z-index: 99;" src="/carhartl/jquery-cookie/ref-list/master/src/jquery.cookie.js?source_action=show&amp;source_controller=blob" preload>
  ...
  <div class="commit-tease">
      ...
      <div>
        <a rel="author" data-skip-pjax="true" data-hovercard-user-id="21918" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/carhartl"><img class="avatar" src="https://avatars0.githubusercontent.com/u/21918?s=40&amp;v=4" width="20" height="20" alt="@carhartl" /></a>
        <a class="user-mention" rel="author" data-hovercard-user-id="21918" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/carhartl">carhartl</a>
...
Closes #336." class="message" href="/carhartl/jquery-cookie/commit/4527b3725ce7b61066e6aa12bbe8d20c0371a1d7">Fix removing cookies in sub paths</a>
      </div>
    ...
    <div class="Box-header">
      ...
      <h3 class="Box-title">Users who have contributed to this file</h3>
        ...
        <ul class="list-style-none overflow-auto">
            ...
            <li class="Box-row">
              <a class="link-gray-dark no-underline" href="/t0mtaylor">
                <img class="avatar mr-2" alt="" src="https://avatars0.githubusercontent.com/u/975744?s=40&amp;v=4" width="20" height="20" />
                t0mtaylor
</a>            </li>
            <li class="Box-row">
              <a class="link-gray-dark no-underline" href="/Krinkle">
                <img class="avatar mr-2" alt="" src="https://avatars3.githubusercontent.com/u/156867?s=40&amp;v=4" width="20" height="20" />
                Krinkle
</a>            </li>
        </ul>
          ...
          <a class="avatar-link" data-hovercard-user-id="21918" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/carhartl/jquery-cookie/commits/master/src/jquery.cookie.js?author=carhartl">
      <img class="avatar" src="https://avatars0.githubusercontent.com/u/21918?s=40&amp;v=4" width="20" height="20" alt="@carhartl" /> 
</a>    <a class="avatar-link" data-hovercard-user-id="975744" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/carhartl/jquery-cookie/commits/master/src/jquery.cookie.js?author=t0mtaylor">
      <img class="avatar" src="https://avatars0.githubusercontent.com/u/975744?s=40&amp;v=4" width="20" height="20" alt="@t0mtaylor" /> 
</a>    <a class="avatar-link" data-hovercard-user-id="156867" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/carhartl/jquery-cookie/commits/master/src/jquery.cookie.js?author=Krinkle">
      <img class="avatar" src="https://avatars3.githubusercontent.com/u/156867?s=40&amp;v=4" width="20" height="20" alt="@Krinkle" /> 
</a>
    ...
    <div class="BtnGroup">
      ...
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/carhartl/jquery-cookie/commits/master/src/jquery.cookie.js">History</a>
        ...
        <a class="btn-octicon tooltipped tooltipped-nw"
          ...
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form js-update-url-with-hash" action="/carhartl/jquery-cookie/edit/master/src/jquery.cookie.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="KNDpZKDFHWlF5PGSocD0rLp/p1WO5+jtZxfRJEYaHHJqO/r/MmTh6b9GnK8B3/L07W/slouq3qXPYZCo8Cwh3Q==" />
            <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
              aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
              <svg class="octicon octicon-pencil" viewBox="0 0 14 16" version="1.1" width="14" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
            </button>
</form>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form" action="/carhartl/jquery-cookie/delete/master/src/jquery.cookie.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="afhgUAb0PfECV2xKT88lXqdKLEpR9tmsuYqWQpZjgFHWLlNvXZ8VfpcLEq0tuFfAMEwcPYd6j3i01MPLmfWpgQ==" />
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2019 <span title="0.27814s from unicorn-cfc895d5-hnscd">GitHub</span>, Inc.</li>
